...
export function StoreFooter() {
  ...
  return (
    <footer className="store-footer">
      ...
      <div className="container-wide footer-bottom"><span>© 2026 MERS Tassel · Istanbul</span><LanguageSwitch /><a href="https://instagram.com" aria-label="Instagram"><Camera size={17} /></a></div>
    </footer>
  );
}
